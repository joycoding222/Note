> **说明**：
>
> 本笔记参考了B站课程[【C++】算法竞赛常用 STL 用法_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1L8411y7th/?spm_id_from=333.1007.top_right_bar_window_custom_collection.content.click&vd_source=a321cb3d239ab59d4a6009d7c3df7720)



**C++ 标准模板库 (STL, Standard Template Library)**：包含一些常用数据结构与算法的模板的 C++ 软件库。其包含四个组件——算法 (Algorithms)、容器 (Containers)、仿函数 (Functors)、迭代器 (Iterators)、适配器(adapter).
